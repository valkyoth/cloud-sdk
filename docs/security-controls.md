...
| pentest provenance | OpenSSH-signed commit/path/SHA-256 attestation for an immutable report Git blob, from an approved key distinct from the release signer |
