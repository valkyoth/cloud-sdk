...
existing `cloud-sdk-hetzner/serde` feature.
...
core facade. Sanitization remains unchanged and excluded from publication.
...
- protected staging cleanup and redacted diagnostics;
