...
the stable release candidate. Its Low dependency-pin finding is remediated and
the final retest is fully green with no other finding. The local release gate
and green GitHub CI and CodeQL remain required before publication.
...
| Crate | Published | Source | Change | Publish | Reason |
| --- | --- | --- | --- | --- | --- |
| `cloud-sdk` | `0.75.0` | `0.79.0` | `metadata` | No | Record the Robot cancellation milestone without publishing the cumulative train. |
| `cloud-sdk-hetzner` | `0.42.0` | `0.42.0` | `code` | No | Accumulate nine cancellation requests, protected models, and strict checked decoding for v0.80.0. |
| `cloud-sdk-reqwest` | `0.35.0` | `0.35.0` | `unchanged` | No | No transport boundary changes. |
...
| Crate | Published | v0.92 | Change | Publish | Reason |
| --- | --- | --- | --- | --- | --- |
...
## v0.93.0 Tracking Table

`v0.93.0` implements all three active billable Robot ordering mutations. It
remains inside the v0.91-v0.95 cumulative train and does not publish any crate.

| Crate | Published | v0.93 | Change | Publish | Reason |
| --- | --- | --- | --- | --- | --- |
| `cloud-sdk` | `0.90.0` | `0.93.0` | `code` | No | Advance the internal guarded Robot order milestone; defer publication to v0.95.0. |
| `cloud-sdk-hetzner` | `0.45.0` | `0.45.0` | `code` | No | Accumulate source-locked catalogs, transactions, and cost-authorized orders for v0.95.0. |
