...
**Status:** historical reviewed snapshot  
**Topics:** Result; Local Package Changes; Required Verification  
**Full snapshot:** [signed-tag source](https://github.com/valkyoth/cloud-sdk/blob/v0.49.0/docs/DEPENDENCY_REVIEW_0.49.0.md)

## v0.50.0

**Status:** historical reviewed snapshot  
**Topics:** Result; Local Package Changes; Root Lockfile Changes; Required Verification  
...
**Status:** historical reviewed snapshot  
**Topics:** Result; Root Lockfile Changes; Required Verification  
...
**Status:** historical reviewed snapshot  
**Topics:** Result; Independent Package Versions; Root Lockfile Changes Since v0.54; Required Verification  
**Full snapshot:** [signed-tag source](https://github.com/valkyoth/cloud-sdk/blob/v0.55.0/docs/DEPENDENCY_REVIEW_0.55.0.md)

## v0.56.0

**Status:** historical reviewed snapshot  
**Topics:** Result; Package Versions; Root Lockfile Changes Since v0.55; Required Verification  
...
**Topics:** Result; Root Lockfile Changes; Cumulative Review  
...
**Status:** release candidate; pentest and final retest passed.  
**Topics:** Independent Versions; Root Lockfile Changes; Rejected AWS-LC Update  
...
**Status:** release candidate; pentest and final retest passed.  
**Topics:** Independent Versions; Root Lockfile Changes; Cumulative Transport Decision; Fuzz Boundary  
**Full snapshot:** [signed-tag source](https://github.com/valkyoth/cloud-sdk/blob/v0.75.0/docs/DEPENDENCY_REVIEW_0.75.0.md)

## v0.76.0

**Status:** release candidate; pentest and final retest passed.  
**Topics:** Root Lockfile Changes; Independent Versions  
...
**Status:** release candidate; pentest and final retest passed.  
**Topics:** Root Lockfile Changes; Publication Selection  
...
**Status:** implementation stop; pentest required.  
**Topics:** Lockfile Changes; Publication Selection  
...
**Status:** implementation stop; pentest required.  
**Topics:** Result; Lockfile Changes; Publication Selection  
