...
- PASS. Permanent report: `security/pentest/v0.7.0.md`.
- Retest is green. No blocking findings remain for tagging `v0.7.0`.

## Publishing Plan

- `cloud-sdk` publishes as `0.7.0`.
- `cloud-sdk-hetzner` publishes as `0.7.0`.
- `cloud-sdk-hetzner-reqwest` publishes as `0.7.0`.
- `cloud-sdk-hetzner-sanitization` publishes as `0.7.0`.
- `cloud-sdk-hetzner-testkit` publishes as `0.7.0`.
