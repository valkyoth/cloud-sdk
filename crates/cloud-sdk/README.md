...
| [`DigitalOcean`](https://docs.digitalocean.com/reference/api/) | planned | full public API roadmap, including preview APIs, Paperspace and supported HTTP data planes |
...
- [crates.io version, dependency and README contract](https://github.com/valkyoth/cloud-sdk/blob/main/docs/CRATESIO_VERSION_POLICY.md)
