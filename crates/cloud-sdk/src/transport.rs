...
pub use endpoint::{
    ...
    EndpointIdentityError, EndpointPairPolicy, EndpointPairPolicyError, EndpointPolicy,
    EndpointPolicyError, EndpointPolicyKind, EndpointScheme, MAX_ENDPOINT_BASE_PATH_BYTES,
    MAX_ENDPOINT_HOST_BYTES, MAX_ENDPOINT_REGION_BYTES, MAX_OFFICIAL_ENDPOINTS,
    MAX_REGIONAL_ENDPOINT_PAIRS, RegionEndpoint, RegionalEndpointPair,
};
pub use header::{
