...
operation_associations!(
        ...
        (ChangeStorageBoxProtection, "change_storage_box_protection", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, ActionResponse, NoPagination, NeverRetry, DestructivePermit),
        (ChangeStorageBoxSubaccountHomeDirectory, "change_storage_box_subaccount_home_directory", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, ActionResponse, NoPagination, NeverRetry, MutationPermit),
        (ChangeStorageBoxType, "change_storage_box_type", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, ActionResponse, NoPagination, NeverRetry, CostPermit),
        ...
        (CreateStorageBox, "create_storage_box", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, CompositeResponse, NoPagination, NeverRetry, CostPermit),
        (CreateStorageBoxSnapshot, "create_storage_box_snapshot", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, CompositeResponse, NoPagination, NeverRetry, MutationPermit),
        (CreateStorageBoxSubaccount, "create_storage_box_subaccount", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, CompositeResponse, NoPagination, NeverRetry, MutationPermit),
        ...
        (DeleteStorageBox, "delete_storage_box", StorageService, StorageEndpointPolicy, BearerAuthentication, DeleteMethod, QueryForbidden, BodyForbidden, StatusCreated, ActionResponse, NoPagination, NeverRetry, DestructivePermit),
        (DeleteStorageBoxSnapshot, "delete_storage_box_snapshot", StorageService, StorageEndpointPolicy, BearerAuthentication, DeleteMethod, QueryForbidden, BodyForbidden, StatusCreated, ActionResponse, NoPagination, NeverRetry, DestructivePermit),
        (DeleteStorageBoxSubaccount, "delete_storage_box_subaccount", StorageService, StorageEndpointPolicy, BearerAuthentication, DeleteMethod, QueryForbidden, BodyForbidden, StatusCreated, ActionResponse, NoPagination, NeverRetry, DestructivePermit),
        ...
        (DisableStorageBoxSnapshotPlan, "disable_storage_box_snapshot_plan", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, BodyForbidden, StatusCreated, ActionResponse, NoPagination, NeverRetry, DestructivePermit),
        ...
        (EnableStorageBoxSnapshotPlan, "enable_storage_box_snapshot_plan", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, ActionResponse, NoPagination, NeverRetry, MutationPermit),
        ...
        (GetStorageBox, "get_storage_box", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, QueryForbidden, BodyForbidden, StatusOk, ResourceResponse, NoPagination, ExplicitRetry, NoPermit),
        (GetStorageBoxSnapshot, "get_storage_box_snapshot", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, QueryForbidden, BodyForbidden, StatusOk, ResourceResponse, NoPagination, ExplicitRetry, NoPermit),
        (GetStorageBoxSubaccount, "get_storage_box_subaccount", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, QueryForbidden, BodyForbidden, StatusOk, ResourceResponse, NoPagination, ExplicitRetry, NoPermit),
        (GetStorageBoxType, "get_storage_box_type", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, QueryForbidden, BodyForbidden, StatusOk, ResourceResponse, NoPagination, ExplicitRetry, NoPermit),
        (GetStorageBoxesAction, "get_storage_boxes_action", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, QueryForbidden, BodyForbidden, StatusOk, ActionResponse, NoPagination, ExplicitRetry, NoPermit),
        ...
        (ListStorageBoxActions, "list_storage_box_actions", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, OptionalQuery, BodyForbidden, StatusOk, ActionsPageResponse, NumberedPagination, ExplicitRetry, NoPermit),
        (ListStorageBoxFolders, "list_storage_box_folders", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, QueryForbidden, BodyForbidden, StatusOk, FoldersResponse, NoPagination, ExplicitRetry, NoPermit),
        (ListStorageBoxSnapshots, "list_storage_box_snapshots", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, OptionalQuery, BodyForbidden, StatusOk, ResourceListResponse, NoPagination, ExplicitRetry, NoPermit),
        (ListStorageBoxSubaccounts, "list_storage_box_subaccounts", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, OptionalQuery, BodyForbidden, StatusOk, ResourceListResponse, NoPagination, ExplicitRetry, NoPermit),
        (ListStorageBoxTypes, "list_storage_box_types", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, OptionalQuery, BodyForbidden, StatusOk, ResourcePageResponse, NumberedPagination, ExplicitRetry, NoPermit),
        (ListStorageBoxes, "list_storage_boxes", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, OptionalQuery, BodyForbidden, StatusOk, ResourcePageResponse, NumberedPagination, ExplicitRetry, NoPermit),
        (ListStorageBoxesActions, "list_storage_boxes_actions", StorageService, StorageEndpointPolicy, BearerAuthentication, GetMethod, OptionalQuery, BodyForbidden, StatusOk, ActionsPageResponse, NumberedPagination, ExplicitRetry, NoPermit),
        ...
        (ResetStorageBoxPassword, "reset_storage_box_password", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, ActionResponse, NoPagination, NeverRetry, DestructivePermit),
        (ResetStorageBoxSubaccountPassword, "reset_storage_box_subaccount_password", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, ActionResponse, NoPagination, NeverRetry, DestructivePermit),
        ...
        (RollbackStorageBoxSnapshot, "rollback_storage_box_snapshot", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, ActionResponse, NoPagination, NeverRetry, DestructivePermit),
        ...
        (UpdateStorageBox, "update_storage_box", StorageService, StorageEndpointPolicy, BearerAuthentication, PutMethod, QueryForbidden, JsonBody, StatusOk, ResourceResponse, NoPagination, ExplicitRetry, MutationPermit),
        (UpdateStorageBoxAccessSettings, "update_storage_box_access_settings", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, ActionResponse, NoPagination, NeverRetry, MutationPermit),
        (UpdateStorageBoxSnapshot, "update_storage_box_snapshot", StorageService, StorageEndpointPolicy, BearerAuthentication, PutMethod, QueryForbidden, JsonBody, StatusOk, ResourceResponse, NoPagination, ExplicitRetry, MutationPermit),
        (UpdateStorageBoxSubaccount, "update_storage_box_subaccount", StorageService, StorageEndpointPolicy, BearerAuthentication, PutMethod, QueryForbidden, JsonBody, StatusOk, ResourceResponse, NoPagination, ExplicitRetry, MutationPermit),
        (UpdateStorageBoxSubaccountAccessSettings, "update_storage_box_subaccount_access_settings", StorageService, StorageEndpointPolicy, BearerAuthentication, PostMethod, QueryForbidden, JsonBody, StatusCreated, ActionResponse, NoPagination, NeverRetry, MutationPermit),
