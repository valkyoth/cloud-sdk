//! Complete blocking Cloud client workflow against a deterministic transport.
...
const RESPONSE: &[u8] = br#"{"locations":[],"meta":{"pagination":{"page":1,"per_page":25,"previous_page":null,"next_page":null,"last_page":1,"total_entries":0}}}"#;
...
fn main() -> Result<(), Box<dyn core::error::Error>> {
    ...
    let checked = client.list_locations_blocking(&operation, lease)?;
    assert!(matches!(checked.success(), HetznerSuccess::Locations(_)));
