...
targets="buffer_writers request_targets action_requests labels_dns pagination quota_retry retry_policy pagination_opaque provider_links action_polling response_envelopes response_content_type checked_response raw_response_parser raw_http1_wire incremental_json"
...
echo "fuzz harness: ${mode} passed for 16 targets"
