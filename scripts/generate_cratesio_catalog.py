...
def render(document):
    schemas = document["components"]["schemas"]
    table = projection(document, {"VERSION": schemas["Version"]})
    fixtures = {}
